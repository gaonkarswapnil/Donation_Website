...
import com.donation.dao.UpdateNgoDao;

/**
 * Servlet implementation class UpdateNgoServlet
 */
@WebServlet("/UpdateNgoServlet")
public class UpdateNgoServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateNgoServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String ngoname = request.getParameter("ngoname");
	 	...
	 	UpdateNgoDao.update(ngoname, managername, email, address, state, district, pincode, description, mobileno, food_donation_flag, clothes_donation_flag, medicine_donation_flag, money_donation_flag);
