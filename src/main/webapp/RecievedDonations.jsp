...
<body>
    ...
    <h1 class="footer-title" align="center">Donation Recieved <span class="title-under"></span></h1>
    <br>    
    <table class="w3-table-all w3-xlarge" align="center" border="2">
		...
		<tr>
			...
			<td>
				<center>${donate.DONAR_EMAIL}</center>
                
            </td>
			<td>
				<center>${donate.ADDRESS }</center>
                
            </td>
			<td>
				<center>${donate.PINCODE}</center>
    ...
    <footer class="main-footer">
        ...
        <div class="footer-bottom" align="center">
            <a href="RecievedDonations.jsp" data-toggle="tooltip" title="TO TOP">
