...
<body>
	<form action="../ngoReview" method="post">
	<sql:setDataSource
        var="myDS"
    ...
    <sql:query var="listNGO"   dataSource="${myDS}">
        SELECT `NGO_NAME`,`MANAGER_NAME`,`ADDRESS`, `STATE`,`DISTRICT`,`PINCODE`,`DESCRIPTION`, `EMAIL`, `CONTACT_NO`,`FOOD_DONATION_FLAG`,`CLOTHES_DONATION_FLAG`,`MEDICINE_DONATION_FLAG`,`MONEY_DONATION_FLAG`,`IS_REVIEWED`,`NGO_ID` FROM `NGO_DETAILS`  WHERE `IS_REVIEWED`=false;
    </sql:query>
                ...
                <div class="container">
                    ...
                    <div id="navbar" class="navbar-collapse collapse pull-right">
                       ...
                       <ul class="nav navbar-nav">
                            ...
                            <li class=""><a class="is-active" href="review.jsp"><span class="glyphicon glyphicon-ok"></span>&nbsp; Review</a>
                            ...
                            <li class="has-child"><a href="#"><span class="fa fa-eye"></span>&nbsp;&nbsp;VIEW</a>
                                <ul class="submenu">
    ...
    <br>
    <h1 align='center'>Approve NGO Registration</h1>
    <br>    
    ...
    <table class="w3-table-all w3-xlarge" align="center" border="2">
        ...
        <tr id='data'>
            <td>
                ...
                NGO Name: <input type="textbox" name="ngoname" value='${ngo.NGO_NAME}' readonly ><br>
               ...
               <c:if test="${ngo.MEDICINE_DONATION_FLAG}">Medicine</c:if>
                ...
                Email id: <input type="textbox" name="email" value='${ngo.EMAIL}' readonly ><br>
                Contact no: ${ngo.CONTACT_NO}
            </td>
            <td>	
				<center>
					&emsp;&emsp;&emsp;<button type="submit" name="review" id="acceptButton" class="btn btn-primary btn-md" value="accept"><span class="glyphicon glyphicon-ok"></span>Accept</button> &emsp;&emsp;&emsp; <br>
					&emsp;&emsp;&emsp;<button type="submit" name="review" id="rejectButton" class="btn btn-primary btn-md" value="reject"><span class="fa fa-times"></span>Reject</button> &emsp;&emsp;&emsp; <br>
				</center>
            </td>
        </tr>
        </c:forEach>
...
<!-- main Content -->
    ...
    <footer class="main-footer">
        ...
        <div class="footer-bottom" align="center">
            <a href="review.jsp" data-toggle="tooltip" title="TO TOP">
