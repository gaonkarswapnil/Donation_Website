...
<body>
    ...
    <sql:query var="listUser"   dataSource="${myDS}">
        SELECT `user_id`,`firstname`,`lastname`,`address`,`state`,`district`,`pincode`,`email`,`mobile_no` FROM `user_login`;
    </sql:query>
   ...
   <br>
    ...
    <table class="w3-table-all w3-xlarge" align="center" border="2">
		...
		<tr>
			...
			<td>
				<center> ${user.STATE} </center>
                
            </td>
			<td>
				<center> ${user.PINCODE} </center>
...
<!-- main Content -->
    ...
    <footer class="main-footer">
        ...
        <div class="footer-bottom" align="center">
            <a href="viewMembers.jsp" data-toggle="tooltip" title="TO TOP">
