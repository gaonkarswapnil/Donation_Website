                ...
                <div class="container">
                    ...
                    <div id="navbar" class="navbar-collapse collapse pull-right">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li><a class="is-active" href="index.jsp"><span class="glyphicon glyphicon-home"></span>&nbsp; HOME</a></li>
            ...
            <div class="item active">
                ...
                <div class="container">
                    ...
                    <div class="carousel-caption">
                        ...
                        <a href="login.jsp" class="btn btn-lg btn-secondary hidden-xs bounceInUp animated slow" >DONATE NOW</a>
            ...
            <div class="item ">
                ...
                <div class="container">
                    ...
                    <div class="carousel-caption">
                        ...
                        <a href="login.jsp" class="btn btn-lg btn-secondary hidden-xs bounceInUp animated" >DONATE NOW</a>
