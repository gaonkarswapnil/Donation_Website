...
<!-- main Content -->
    ...
    <!-- <div class="page-heading text-center">  -->
        ...
        <div class="container zoomIn animated">
            <h1 class="page-title"><center>NGO Registration</center><span class="title-under"></span></h1>
        </div>
    ...
    <div class="container">
        ...
        <hr>
        <form class="form-horizontal"  method="POST" action="ListNgo">
			...
			<div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="textbox" class="form-control" id="managername" name="managername" placeholder="Enter Manager name" required>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-sm-4" for="email">Email Id:</label>
                <div class="col-sm-6">
                    <input type="textbox" class="form-control" id="email" name="email" placeholder="Enter Email" value=<%=session.getAttribute("username") %> readonly>
                </div>
            </div>
			<div class="form-group">
                <label class="control-label col-sm-4" for="address">Address:</label>
                <div class="col-sm-6">
                    <textarea id="address" name="address" placeholder="Enter address" class="form-control" rows="5" title ="Please enter description" required></textarea>
                </div>
            </div>
			<div class="form-group">
			...
			<div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="textbox" class="form-control" id="district" name="district" placeholder="Enter State" required>
                </div>
            </div>
			<div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <textarea id="description" name="description" placeholder="Enter description" class="form-control" rows="5" title ="Please enter description" required></textarea>
                </div>
            </div>
			<div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <label class="control-label col-sm-3">
                        <input type="checkbox" name="donationtype" value="money" checked="checked" required>
...
<!-- main Content -->
    <footer class="main-footer">
        ...
        <div class="footer-bottom" align="center">
            <a href="listanNGO.jsp" data-toggle="tooltip" title="TO TOP">
