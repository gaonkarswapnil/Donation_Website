...
<body>
        ...
        <nav class="navbar navbar-static-top">
            <div class="navbar-main">
                ...
                <div class="container">
                    ...
                    <!--
                        <a class="navbar-brand" href="index.jsp"><img src="assets/images/logo.png" alt="" width="60px" padding="10px"></a>
                    -->
                    </div>
                    ...
                    <div id="navbar" class="navbar-collapse collapse pull-right">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li><a class="" href="index.jsp"><span class="glyphicon glyphicon-home"></span>&nbsp; HOME</a></li>
    ...
    <!-- <div class="page-heading text-center">  -->
		...
		<div class="container zoomIn animated">
			<h1 class="page-title"><center>User Login</center> <span class="title-under"></span></h1>
		</div>
    ...
    <div class="container">
        ...
        <form class="form-horizontal" action="login" method="POST">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="password" id="userpass" name="userpass" placeholder="Enter password" class="form-control" required>
                </div>
            </div>
...
<!--Main Content-->
    ...
    <footer class="main-footer">
        ...
        <div class="footer-bottom" align="center">
            <a href="login.jsp" data-toggle="tooltip" title="TO TOP">
