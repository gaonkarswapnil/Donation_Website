...
<body>
    ...
    <sql:query var="listNGO"   dataSource="${myDS}">
        SELECT `NGO_NAME`,`MANAGER_NAME`,`ADDRESS`, `STATE`,`DISTRICT`,`PINCODE`,`DESCRIPTION`, `EMAIL`, `CONTACT_NO`,`FOOD_DONATION_FLAG`,`CLOTHES_DONATION_FLAG`,`MEDICINE_DONATION_FLAG`,`MONEY_DONATION_FLAG`,`IS_REVIEWED`,`NGO_ID` FROM `NGO_DETAILS` WHERE `EMAIL`='<%=session.getAttribute("username")%>';
    </sql:query>
                ...
                <div class="container">
                    ...
                    <div id="navbar" class="navbar-collapse collapse pull-right">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="has-child"><a class="" href="donate.jsp"><span class="fa fa-inr"></span>&nbsp; DONATE</a>
...
<!-- Main content -->
        	...
        	<td>
        		<center>
        			<button type="button" class="btn btn-default btn-lg">
						<a href="edit_ngo.jsp?ngo_id=${ngo.NGO_ID}"><span class="glyphicon glyphicon-edit" ></span></a>
					</button>
        		</center>
        	</td>
    ...
    <footer class="main-footer">
        ...
        <div class="footer-bottom" align="center">
            <a href="view.jsp" data-toggle="tooltip" title="TO TOP">
